...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      {/* Hero Section */}
      <Section id="landing" className="bg-gray-500 text-white py-20 mt-14 h-screen">
      ...
      <Section id="about" className="dark:bg-gray-900 dark:text-white">
        <Blockquote className="my-4 border-l-4 border-gray-300 bg-gray-200 p-6 dark:border-gray-500 dark:bg-gray-800">
      ...
      <Section id="projects" title="Minecraft Project">
        ...
        <Button
          className="mx-auto mt-10 xl:mt-0 hover:bg-blue-700 hover:scale-105 transition-transform duration-300"
          color="blue"
          pill
        >
