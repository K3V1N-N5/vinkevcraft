  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      <section
        id="about"
        ref={aboutSectionRef}
        className="py-12 bg-white dark:bg-gray-900 text-gray-900 dark:text-white w-full flex flex-col items-center justify-center"
      >
        <div className="container mx-auto text-center px-4 max-w-4xl">
          <h1 className="text-3xl font-bold mb-6 mt-20 text-gray-900 dark:text-white">About Me</h1>
          <Blockquote className="my-4 border-l-4 border-gray-300 bg-gray-200 p-6 rounded-lg dark:border-gray-500 dark:bg-gray-800">
        ...
        <div className="mt-16 w-full flex flex-col items-center">
          <h1 className="text-center text-3xl font-bold mb-12 text-gray-900 dark:text-white">My Minecraft Projects</h1>
        ...
        <div className="text-center mt-10">
          <Button className="mx-auto" color="blue" pill size="lg">
            <Link to="/list" className="text-white dark:text-white">View My Projects</Link>
          </Button>
        </div>
      </section>
    </div>
