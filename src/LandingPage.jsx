          ...
          <div className="relative w-full max-w-3xl mx-auto overflow-hidden rounded-lg">
            <Carousel slideInterval={3000} pauseOnHover>
              {data.map((slideItem, slideIndex) => (
                <div key={slideIndex} className="relative w-full h-80">
                  <img
                    src={slideItem.img}
                    alt={slideItem.title}
            ...
            <Button
              className="mx-auto mt-6 bg-blue-600 text-white hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 border border-transparent transition-colors duration-300"
              pill
            >
