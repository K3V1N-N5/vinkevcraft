    ...
    <div className="flex flex-col min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      >
        <div className="container mx-auto text-center px-4">
          ...
          <Blockquote className="my-4 mx-auto max-w-4xl border-l-4 border-gray-300 bg-gray-200 p-6 rounded-lg dark:border-gray-500 dark:bg-gray-800 text-gray-900 dark:text-white">
