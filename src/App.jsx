  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        <Button onClick={handleOpen} class="inline-flex items-center text-xs text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
      ...
      <DarkThemeToggle class="flex text-sm rounded-full focus:ring-4 dark:text-white mr-2"/>
      </div>
    </div>
  </div>
</nav>
